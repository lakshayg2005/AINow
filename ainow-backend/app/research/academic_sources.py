...
async def search_semantic_scholar(
    ...
    try:
        ...
        raise RuntimeError(
            f"Could not connect to Semantic Scholar: {error}"
        ) from error
    ...
    for paper in data.get("data", []):
        ...
        # Skip papers outside our requested window.
        if (
        ...
        # Prefer DOI when available because it
        # gives us better cross-source matching.
